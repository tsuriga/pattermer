...
module.exports.Pattermer = class
{
    ...
    bindOpenDirectoryButton() {
        ...
        btnOpenDirectory.addEventListener('click', (e) => {
            ...
            const directoryPath = dialog.showOpenDialog({ properties: ['openDirectory'] })[0],
                filenameList = fs.readdirSync(directoryPath);

            this.fileList = [];

            for (const filename of filenameList) {
                this.fileList.push(path.join(directoryPath, filename));
            }
    ...
    bindRemoveVariableButton() {
        this.getElement('#btnRemoveVar').addEventListener('click', (e) => {
            ...
            delete(this.cfg.sets[this.cfg.activeSet]['variables'][varToRemove.textContent]);
