...
module.exports.Pattermer = class
{
    ...
    bindDrags() {
        this.bindVariableDrags();
    }

    bindVariableDrags() {
        this.bindVariablesToQueueDrags();
        this.bindQueueReorderingDrags();
    }

    bindVariablesToQueueDrags() {
    ...
    bindQueueReorderingDrags() {
        ...
        queueItemList.addEventListener('dragstart', (e) => {
            ...
            e.target.classList.add('queueItemDragged');

            dragOrigin = queueItemList;
            this.queueDragSource = e.target;
        });

        queueItemList.addEventListener('dragend', (e) => {
            if (dragOrigin === queueItemList) {
                e.target.classList.remove('queueItemDragged');
    ...
    addQueueItem(itemText) {
        ...
        this.getElement('#queueItems').appendChild(li);
