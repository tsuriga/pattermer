...
module.exports.Pattermer = class
{
    ...
    bindVariablePaneDrags() {
        ...
        this.createSelfUpdatingDragster(queue, queueItemList);
    ...
    /**
     * @param Node dropzone
     * @param Node elementContainer
     */
    createSelfUpdatingDragster(dropzone, elementContainer) {
        let dragster = new Dragster(dropzone);

        const observer = new MutationObserver((mutation) => {
            dragster.removeListeners();
            dragster = new Dragster(dragster.el);
        });
