...
module.exports.Pattermer = class
{
    ...
    bindScrollbarChecks() {
        const regexpList = document.querySelector('#regexpItems'),
            regexpPane = document.querySelector('#regexpPane'),
            navVarList = document.querySelector('#navigationVariables'),
     ...
     *
     * In addition executes forceful repaints to panes to fix scenarios where
     * they appear with extra margin
     *
     * @param Node element
     */
