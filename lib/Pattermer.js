...
module.exports.Pattermer = class
{
    ...
    bindSavePresetButton() {
        ...
        btnSavePreset.addEventListener('click', (e) => {
            ...
            this.prompt('savePreset', (formData) => {
                const setData = this.cfg.sets[this.cfg.activeSet];
     ...
     */
    prompt(templatePath, callback) {
        if (!this.loadTemplate(templatePath)) {
            return;
        }
        ...
        // bind success and cancel buttons
        // success button executes callback with form data
    }
     ...
     * @return bool True if loading the template succeeded, false otherwise
     */
